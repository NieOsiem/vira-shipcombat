# Blank Hull — Fast (blank-fast) — balance report

- Build source: hull file `world-data/hulls/blank-fast.js` + components file `world-data/components/medium-components.js` through materializeShipConfig
- Components: 36 supplied component sources, 0 installed
- Encounter state: materializeShipConfig + createInitialState — full health (hull 40 of 40, shields ) at the shipped power commit (engines 0 · shields 0 · sensors 0 · cooling 0 · inertia 0 · weapons 0)
...
| --- | --- | --- | --- |
| Reactor | blank-fast-slot-reactor | reactor / medium | empty |
| Shield | blank-fast-slot-shield | shield / medium | empty |
| Sensor | blank-fast-slot-sensor | sensor / medium | empty |
| Cooling | blank-fast-slot-cooling | cooling / medium | empty |
| Main Drive | blank-fast-slot-main-drive | drive / medium | empty |
| Reverse Drive | blank-fast-slot-reverse-drive | drive / medium | empty |
| Port Lateral Drive | blank-fast-slot-port-lateral-drive | drive / medium | empty |
| Starboard Lateral Drive | blank-fast-slot-starboard-lateral-drive | drive / medium | empty |
| Inertial Anchor | blank-fast-slot-inertia | inertia / medium | empty |
...
Heat figures assume healthy hardware (fault multipliers are 1). At this commit a full Heat bar (20 Heat Capacity) would clear in — Start(s) of passive cooling alone. Emergency Vent removes nothing at this fit.
...
| orbit 21.6 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
| alt orbit 21.6 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
report written to tools/balance/blank-fast.md
