# Blank Hull — Balanced (blank-balanced) — balance report

- Build source: hull file `world-data/hulls/blank-balanced.js` + components file `world-data/components/medium-components.js` through materializeShipConfig
- Components: 36 supplied component sources, 0 installed
- Encounter state: materializeShipConfig + createInitialState — full health (hull 48 of 48, shields ) at the shipped power commit (engines 0 · shields 0 · sensors 0 · cooling 0 · inertia 0 · weapons 0)
...
| --- | --- | --- | --- |
| Reactor | blank-balanced-slot-reactor | reactor / medium | empty |
| Shield | blank-balanced-slot-shield | shield / medium | empty |
| Sensor | blank-balanced-slot-sensor | sensor / medium | empty |
| Cooling | blank-balanced-slot-cooling | cooling / medium | empty |
| Main Drive | blank-balanced-slot-main-drive | drive / medium | empty |
| Reverse Drive | blank-balanced-slot-reverse-drive | drive / medium | empty |
| Port Lateral Drive | blank-balanced-slot-port-lateral-drive | drive / medium | empty |
| Starboard Lateral Drive | blank-balanced-slot-starboard-lateral-drive | drive / medium | empty |
| Inertial Anchor | blank-balanced-slot-inertia | inertia / medium | empty |

| hardpoint | orientation | regions | weapon |
| --- | --- | --- | --- |
| Fore | 0° | fore | empty |
| Port | -90° | port | empty |
| Starboard | 90° | starboard | empty |
...
| orbit 15.6 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
| alt orbit 15.6 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
report written to tools/balance/blank-balanced.md
