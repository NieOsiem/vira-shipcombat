# Blank Hull — Armed Trader (blank-trader) — balance report

- Build source: hull file `world-data/hulls/blank-trader.js` + components file `world-data/components/medium-components.js` through materializeShipConfig
- Components: 36 supplied component sources, 0 installed
- Encounter state: materializeShipConfig + createInitialState — full health (hull 44 of 44, shields ) at the shipped power commit (engines 0 · shields 0 · sensors 0 · cooling 0 · inertia 0 · weapons 0)
...
| --- | --- | --- | --- |
| Reactor Bay (oversized) | blank-trader-slot-reactor | reactor / medium | empty |
| Shield | blank-trader-slot-shield | shield / medium | empty |
| Sensor | blank-trader-slot-sensor | sensor / medium | empty |
| Cooling | blank-trader-slot-cooling | cooling / medium | empty |
| Main Drive | blank-trader-slot-main-drive | drive / medium | empty |
| Reverse Drive | blank-trader-slot-reverse-drive | drive / medium | empty |
| Port Lateral Drive | blank-trader-slot-port-lateral-drive | drive / medium | empty |
| Starboard Lateral Drive | blank-trader-slot-starboard-lateral-drive | drive / medium | empty |
| Inertial Anchor | blank-trader-slot-inertia | inertia / medium | empty |

| hardpoint | orientation | regions | weapon |
| --- | --- | --- | --- |
| Fore | 0° | fore | empty |
| Stern Chaser | 180° | aft | empty |
...
Heat figures assume healthy hardware (fault multipliers are 1). At this commit a full Heat bar (26 Heat Capacity) would clear in — Start(s) of passive cooling alone. Emergency Vent removes nothing at this fit.
...
| orbit 13.2 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
| alt orbit 13.2 mirror | 40 | 0% | — | — | 0 / 0 | 0 / 0 | pool | 0 | 0 | — | — | 0 | 0 | armEvasion:EVASION_ENGINES_UNPOWERED×3200, ping:SENSORS_OFFLINE×3200, acquire:SENSORS_OFFLINE×3200 |
...
report written to tools/balance/blank-trader.md
